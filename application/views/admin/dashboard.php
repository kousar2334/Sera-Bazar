...
if($name){
	...
	<html>
	<head>
		<title><?php echo isset($title) ? $title : 'Admin Panel |Sera Bazar' ; ?></title>
	...
	<link href="<?php echo base_url();?>css/owl.carousel1.css" rel="stylesheet">
	<script src="<?php echo base_url();?>js/owl.carousel1.js"></script>
	<script>
		$(document).ready(function() {
			...
			<aside class="sidebar-left">
				<nav class="navbar navbar-inverse">
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="index.html"><span class="fa fa-area-chart"></span>Sera Bazar<span class="dashboard_text">Admin Dashboard</span></a></h1>
					</div>
							...
							<li class="treeview">
								...
								<li class="treeview">
									...
									<ul class="treeview-menu">
										<li><a href="<?php echo base_url();?>add-admin"><i class="fa fa-angle-right"></i> Add Admin</a></li>
										<li><a href="<?php echo base_url();?>add-category"><i class="fa fa-angle-right"></i> Add Category</a></li>
										<li><a href="<?php echo base_url();?>add-sub-category"><i class="fa fa-angle-right"></i> Add Subcategory</a></li>
										<li><a href="<?php echo base_url();?>add-item"><i class="fa fa-angle-right"></i> Add Item Group</a></li>
										<li><a href="<?php echo base_url();?>add-product"><i class="fa fa-angle-right"></i> Add Product</a></li>
										<li><a href="<?php echo base_url();?>add-inventory"><i class="fa fa-angle-right"></i> Add Inventory</a></li>
									</ul>
								</li>
										...
										<li id="sender_name"><a href="#">
											...
											foreach ($all_message_info as $message_info) {
												?><div class="notification_desc" >
													<a href="<?php echo base_url();?>view_message/<?php echo $message_info->viewer_msg_id;?>"><?php
														echo $message_info->viewer_name;?></a>										
													<p><span><?php 
													$sending_time=$message_info->sending_date;
									...
									<li class="dropdown profile_details_drop">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">	
												<span class="prfil-img"><img  class="img-circle" src="<?php echo base_url();?>uploads/1.jpg" width="50" height="50" alt=""> </span> 
												<div class="user-name">
													<p><?php
													echo $name;
													?>
